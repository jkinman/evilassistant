...
WAKE_PHRASES = ["evil assistant", "i summon you", "dark one", "cthulhu", "durans dick"]  # Added "durans dick"
STOP_PHRASES = ["shut up", "be silent", "stop", "unsummon"]  # Added "stop" and "unsummon"
